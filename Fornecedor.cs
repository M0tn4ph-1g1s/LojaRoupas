...
namespace LojaRoupas
{
    public partial class Fornecedor : Form
    {
        ...
        {
            InitializeComponent();
            dataGridView1.DataSource = Forn.listarFornecedor();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            if (id > 0) {
                ...
                String contato = textBox2.Text;
                String fone = maskedTextBox1.Text;

                FornecedorDao Forn2 = new FornecedorDao();
                Forn2.editarFornecedor(id,nome, contato, fone);
                textBox1.Enabled = false;
                textBox2.Enabled = false;
                maskedTextBox1.Enabled = false;
                button7.Enabled = false;
            ...
            else if (id == 0)
            {
                ...
                Fornecedor.cadastrarFornecedor(nome, contato, fone);
                textBox1.Enabled = false;
                textBox2.Enabled = false;
                maskedTextBox1.Enabled = false;
                button7.Enabled = false;
        ...
        {
            dataGridView1.DataSource = Forn.preenchergrid(textBox4.Text);
        }
        ...
        public void printDocument1_BeginPrint(Object sender, EventArgs e)
        {
            ...
            con.conectar();
            SqlCommand cmd = new SqlCommand("SELECT nomeFornecedor,contatoFornecedor,foneForcedor from tbFornecedor", con.con);
        ...
        public void printDocument1_PrintPage(Object sender, PrintPageEventArgs e)
        {
            ...
            /*Image newImage = Image.FromFile("controller.png");
